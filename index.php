...
if (isset($_POST['UpdateTableYear'])) {
    $textLength = $pdo->textLength($_POST['number_year'], $_POST['number_month'],
    ...
    include_once(PATH . '/view/select_month.php');
    $articles = $pdo->getArticlesMonth($_POST['number_year'], $_POST['number_month'], $ini_array['sql']['table_name'],
